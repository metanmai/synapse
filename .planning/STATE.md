...
| 260624-vs4 | Slice C: self-sufficient extension — chrome.identity sign-in + direct-POST to /api/capture/browser + daemon fallback + client-side scrub — LOCAL, held for push-approval (extension-only, no auto-deploy) | 2026-06-24 | d5570396 | [260624-vs4-slice-c-extension-self-sufficient-capture](./quick/260624-vs4-slice-c-extension-self-sufficient-capture/) |
