...
Publish release notes for **synapsesync** in [GitHub Releases](https://github.com/metanmai/synapse/releases) or here under a dedicated subsection when you cut npm tags (e.g. `mcp-v*` per `.github/workflows/publish.yml`).
